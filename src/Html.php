 ...
 * using the `$options` parameter. See the documentation of the {@see Html::tag()} method for more details.
 *
...
final class Html
{
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML5, ini_get('default_charset'), $doubleEncode);
    }
     ...
     */
    public static function style($content, $options = []): string
    {
     ...
     */
    public static function script($content, $options = []): string
    {
     ...
     * @see Url::to()
     */
    public static function cssFile($url, $options = []): string
    {
     ...
     * @see Url::to()
     */
    public static function jsFile($url, $options = []): string
    {
     ...
     */
    private static function wrapIntoCondition($content, $condition): string
    {
     ...
     */
    public static function label($content, $for = null, $options = []): string
    {
        $options['for'] = $for;
     ...
     */
    public static function button($content = 'Button', $options = []): string
    {
     ...
     */
    public static function submitButton($content = 'Submit', $options = []): string
    {
        $options['type'] = 'submit';
     ...
     */
    public static function resetButton($content = 'Reset', $options = []): string
    {
        $options['type'] = 'reset';
        return static::button($content, $options);
    }
     ...
     * @return string the generated button tag
     */
    public static function buttonInput($label = 'Button', $options = []): string
    {
        $options['type'] = 'button';
        $options['value'] = $label;
        return static::tag('input', '', $options);
     ...
     * @return string the generated button tag
     */
    public static function resetInput($label = 'Reset', $options = []): string
    {
        $options['type'] = 'reset';
        $options['value'] = $label;
        return static::tag('input', '', $options);
     ...
     */
    public static function textInput($name, $value = null, $options = []): string
    {
     ...
     */
    public static function passwordInput($name, $value = null, $options = []): string
    {
     ...
     */
    public static function fileInput($name, $value = null, $options = []): string
    {
     ...
     */
    public static function textarea($name, $value = '', $options = []): string
    {
        $options['name'] = $name;
     ...
     * @return string the generated checkbox tag
     */
    private static function booleanInput($type, $name, $checked = false, $options = []): string
    {
     ...
     */
    public static function dropDownList($name, $selection = null, $items = [], $options = []): string
    {
     ...
     */
    public static function listBox($name, $selection = null, $items = [], $options = []): string
    {
     ...
     */
    public static function ul($items, $options = []): string
    {
     ...
     */
    public static function ol($items, $options = []): string
    {
        $options['tag'] = 'ol';
     ...
     */
    public static function activeHint($model, $attribute, $options = []): string
    {
        $attribute = static::getAttributeName($attribute);
     ...
     * @return string the generated input tag
     */
    public static function activeInput($type, $model, $attribute, $options = []): string
    {
     ...
     * the attributes of the resulting tag. The values will be HTML-encoded using {@see encode()}.
     */
    private static function setActivePlaceholder($model, $attribute, &$options = []): void
    {
     ...
     * @return string the generated input tag
     */
    public static function activeHiddenInput($model, $attribute, $options = []): string
    {
     ...
     * @return string the generated input tag
     */
    public static function activePasswordInput($model, $attribute, $options = []): string
    {
        self::normalizeMaxLength($model, $attribute, $options);
     ...
     * @return string the generated input tag
     */
    public static function activeFileInput($model, $attribute, $options = []): string
    {
     ...
     */
    public static function activeTextarea($model, $attribute, $options = []): string
    {
        $name = $options['name'] ?? static::getInputName($model, $attribute);
     ...
     * @return string the generated radio button tag
     */
    public static function activeRadio($model, $attribute, $options = []): string
    {
     ...
     * @return string the generated checkbox tag
     */
    public static function activeCheckbox($model, $attribute, $options = []): string
    {
     ...
     */
    private static function activeBooleanInput($type, $model, $attribute, $options = []): string
    {
        $name = $options['name'] ?? static::getInputName($model, $attribute);
        $value = static::getAttributeValue($model, $attribute);
     ...
     * @return string the generated drop-down list tag
     */
    public static function activeDropDownList($model, $attribute, $items, $options = []): string
    {
        if (empty($options['multiple'])) {
     ...
     * @return string the generated list box tag
     */
    public static function activeListBox($model, $attribute, $items, $options = []): string
    {
     ...
     * @return string the generated checkbox list
     */
    public static function activeCheckboxList($model, $attribute, $items, $options = []): string
    {
     ...
     * @return string the generated radio button list
     */
    public static function activeRadioList($model, $attribute, $items, $options = []): string
    {
     ...
     */
    private static function activeListInput($type, $model, $attribute, $items, $options = []): string
    {
        $name = $options['name'] ?? static::getInputName($model, $attribute);
     ...
     */
    public static function renderSelectOptions($selection, $items, &$tagOptions = []): string
    {
        if (ArrayHelper::isTraversable($selection)) {
            $selection = array_map('strval', (array)$selection);
        }
     ...
     * @throws InvalidArgumentException if the attribute name contains non-word characters.
     */
    public static function getAttributeValue($model, string $attribute)
    {
        if (!preg_match(static::$attributeRegex, $attribute, $matches)) {
            throw new \InvalidArgumentException('Attribute name must contain word characters only.');
        }
     ...
     * @throws InvalidArgumentException if the attribute name contains non-word characters.
     */
    public static function getInputName($model, string $attribute): string
    {
        // TODO: fix it
        return $attribute;
     ...
     * @throws InvalidArgumentException if the attribute name contains non-word characters.
     */
    public static function getInputId($model, string $attribute): string
    {
